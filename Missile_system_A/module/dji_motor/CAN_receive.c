...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
		...
		switch (rx_header.StdId)
    {
        ...
        case CAN_3508_S1_ID:
        {
            ...
            detect_hook(missile_shoot_LEFT_MOTOR_TOE );
            break;
        }
        case CAN_3508_S2_ID:
        {
            get_motor_measure(&motor_shoot[rx_header.StdId - CAN_3508_S1_ID], rx_data);
            detect_hook(missile_shoot_RIGHT_MOTOR_TOE );
            break;
        }
        default:
        {
...
void CAN_cmd_shoot(int16_t missile_shoot1,int16_t missile_shoot2 ,int16_t shoot, int16_t rev)
{
   ...
   shoot_can_send_data[0] = (missile_shoot1 >> 8);
   shoot_can_send_data[1] = missile_shoot1;
   shoot_can_send_data[2] = (missile_shoot2 >> 8);
   shoot_can_send_data[3] = missile_shoot2;
